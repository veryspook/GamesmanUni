...
export const activeVVHViews: Array<Types.VVHView> = [{name: VVHViews[0], viewOptions: {toggleOptions: false, toggleScrolling: false, toggleGuides: true}}]; //VVHViews[0] is set as the default view.
