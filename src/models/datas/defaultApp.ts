...
export const VVHViews: Array<string> = ["Remoteness", "Win By", "Draw Level", "Column", "Tree View"];
export const activeVVHViews: Array<Types.VVHView> = [{name: VVHViews[0], viewOptions: {toggleOptions: false, toggleScrolling: false, toggleGuides: true, toggleSideBranchExploration: false}}]; //VVHViews[0] is set as the default view.
